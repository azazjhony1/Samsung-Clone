...
import "./nav.css";
import NavTopDown from "./navTopDown";
    ...
    <>
      ...
      <div className="navbar">
        ...
        <div className="menus">
          ...
          <div className="menu2">
            <div className="insideMenu2">
              <div className="listContainer">
                <ul className="menu2Lists">
                  <li className="menu2List list">Support</li>
                  <li className="menu2List list">For Business</li>
                </ul>
              </div>
      ...
      {down ? <NavTopDown expand={expand} setExpand={setExpand} setDown={setDown}/> : null}
    </>
  );
};
